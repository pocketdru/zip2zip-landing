...
class FullFaq extends Component {
    ...
    toggleTab = (e) => {
        ...
        console.log(this._div.className);
        this._div.focus();
        this._div.className="tab-pane fade";
    }
                    ...
                    <div className="col-md-9">    
                       ...
                       {/*  */}
                        ...
                        <div className="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a className="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">How is my car shipping cost calculated?</a>
                            <div className="tab-content" id="nav-tabContent">
                                <div className="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">When determining your car shipping cost, there are a few factors that we take into account in order to provide you with an accurate price quote. The mileage between the origin and destination is the biggest factor that contributes to your total rate. In addition to the distance of your relocation, another factor is the type and condition of the vehicle being shipped. The final factor is the date that your vehicle will be ready for transport. There are also additional options, such as enclosed carrier and top-load service that can be added to your shipment at the time of booking for a higher level of service.</div>
                           </div>
                            <a className="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">How do I pay for my auto shipping?</a>
                            <div className="tab-content" id="nav-tabContent">
                                <div className="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">We accept all major credit cards, electronic transfer, postal money order, and bank/certified check for the deposit or full pre-payment of your shipment. If a balance is due upon delivery, it can be paid directly to the driver and can be paid in either cash, bank/certified check, or postal money order.</div>
                            </div>
