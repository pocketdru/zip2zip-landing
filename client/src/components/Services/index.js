                    ...
                    <div className="card-deck">
                        <div className="card">
                            ...
                            <div className="card-footer d-flex justify-content-between">
                                ...
                                <img className="tire" src={Tire} alt="Open Carrier Car Shipping"/>
                            </div>
                            </div>
                        </div>
                        <div className="card">
                            ...
                            <div className="card-footer d-flex justify-content-between">
                                ...
                                <img className="tire" src={Tire} alt="Enclosed Car Shipping"/>
                            </div>
                            </div>
                        </div>
                        </div>
                        ...
                        <div className="card">
                            ...
                            <div className="card-footer d-flex justify-content-between">
                                <p className="card-text"><small className="dollars">$$</small></p>
                                <img className="tire" src={Tire} alt="Cross Country Car Shipping"/>
                            </div>
                        </div>
                        </div>
                        <div className="card">
                            ...
                            <div className="card-footer d-flex justify-content-between">
                            <p className="card-text"><small className="dollars">$$</small></p>
                            <img className="tire" src={Tire} alt="Seasonal Car Shipping"/>
                            </div>
                           </div>
                        </div>   
                        </div>      
                        ...
                        <div className="card">
                            ...
                            <div className="card-footer d-flex justify-content-between">
                            <p className="card-text"><small className="dollars">$$$</small></p>
                            <img className="tire" src={Tire} alt="Auction Shipping"/>
                            </div>
                        </div>  
                        </div>
                        <div className="card">
                            ...
                            <div className="card-footer d-flex justify-content-between">
                            <p className="card-text"><small className="dollars">$$</small></p>
                            <img className="tire" src={Tire} alt="College car shipping services"/>
                            </div>
                            </div>
                        </div>
                    </div>
